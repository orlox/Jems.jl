...
# (:jina_rates, :n1_He4_He4_to_Be9_ac12_r_x_0),
# (:jina_rates, :n1_He4_He4_to_Be9_ac12_n_x_0),

# (:jina_rates, :He4_C12_to_O16_nac2_x_x_0),
# (:jina_rates, :He4_C12_to_O16_nac2_x_x_1),

# (:jina_rates, :He4_Be9_to_n1_C12_cf88_r_x_0),
# (:jina_rates, :He4_Be9_to_n1_C12_cf88_r_x_1),
# (:jina_rates, :He4_Be9_to_n1_C12_cf88_r_x_2),
# (:jina_rates, :He4_Be9_to_n1_C12_cf88_r_x_3),
# (:jina_rates, :He4_Be9_to_n1_C12_cf88_n_x_0),
...
open("example_options.toml", "w") do file
    write(file,
          ...
          history_values = ["age", "dt", "model_number", "T", "ρ",
                            "H1", "D2", "He3", "He4", "Li7", "Be7", "Be9", "C12", "N14", "O16", "Ne20"]
...
# history = StellarModels.get_history_dataframe_from_hdf5("history.hdf5")
# lines!(ax, H1_x, log10.(H1_pos), label=L"^1\mathrm{H}")
